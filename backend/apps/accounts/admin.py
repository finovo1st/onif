...
class CustomUserAdmin(UserAdmin):
    list_display = ('email', 'username', 'full_name', 'role', 'is_demo', 'bypass_plan_and_level_requirements', 'kyc_status', 'is_email_verified', 'active_level', 'created_at')
    list_filter = ('is_demo', 'role', 'bypass_plan_and_level_requirements', 'kyc_status', 'is_email_verified', 'is_2fa_enabled', 'is_staff', 'is_superuser', 'is_active')
    ...
    fieldsets = (
        ...
        (_('Role & KYC'), {'fields': ('role', 'is_demo', 'bypass_plan_and_level_requirements', 'kyc_status', 'kyc_document_front', 'kyc_document_back', 'kyc_reviewed_at')}),
        (_('Security & Verification'), {'fields': ('is_email_verified', 'email_otp', 'email_otp_expiry', 'is_2fa_enabled', 'otp_secret')}),
        (_('Referral System'), {'fields': ('referral_code', 'parent', 'active_level', 'active_roi_level')}),
        (_('Permissions'), {
